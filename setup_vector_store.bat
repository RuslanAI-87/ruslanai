@echo off
echo ===================================================
echo Настройка векторного хранилища для RuslanAI
echo ===================================================
echo.
echo Этот скрипт установит необходимые зависимости для
echo работы векторного хранилища, которое требуется для
echo поддержания контекста диалога.
echo.
...
echo  - Запустите start_direct_api.bat или direct_api.py
echo ===================================================
echo.
pause
exit /b 0
